...
f2.add_item(GF.ItemColor.Blue, GF.ItemEffect.GivePoints, GF.ItemBehaviour.Respawn, [(12, 5), (3, 6)])
f2.add_controls(GF.Controls.LeftRight)

f3 = GF()
f3.add_map_layout(GF.MapLayout.DefaultMap2, map_setup)
f3.add_start_position((3, 3))
f3.add_monster(GF.MonsterType.Invincible, GF.MonsterColor.Red, GF.MonsterEffect.Kill, GF.MonsterBehaviour.LeftRight, [(7, 6)])
